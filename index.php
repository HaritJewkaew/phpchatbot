...
if (isset($jsonData["events"][0]["type"]) && $jsonData["events"][0]["type"] == "postback") {
    ...
    if (isset($postbackData['action']) && $postbackData['action'] == 'accept_job') {
        ...
        $userProfile = getUserProfile($userId, ['AccessToken' => 'YOUR_ACCESS_TOKEN']);
        ...
        if ($selectResult) {
            ...
            if ($row) {
                ...
                if ($updateResult) {
                    ...
                    sendMessage($responseJson, ['URL' => "https://api.line.me/v2/bot/message/reply", 'AccessToken' => 'YOUR_ACCESS_TOKEN']);
                } else {
    ...
    if ($selectResult) {
        ...
        if ($row) {
            ...
            if ($updateResult) {
                ...
                sendMessage($replyJson, ['URL' => "https://api.line.me/v2/bot/message/reply", 'AccessToken' => 'YOUR_ACCESS_TOKEN']);
            } else {
